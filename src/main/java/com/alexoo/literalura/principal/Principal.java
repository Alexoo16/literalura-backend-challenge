package com.alexoo.literalura.principal;

import com.alexoo.literalura.domain.autor.Autor;
import com.alexoo.literalura.domain.autor.AutorListarDTO;
import com.alexoo.literalura.domain.autor.AutorRepository;
import com.alexoo.literalura.domain.libro.*;
import com.alexoo.literalura.service.ConsumoAPI;
import com.alexoo.literalura.service.ConversorDatos;
import com.alexoo.literalura.service.RespuestaAPI;
...
public class Principal {
    ...
    private void listarLibros() {
        ...
        var librosListar = libros.stream().map(LibroListarDTO::new).toList();
    ...
    private void listarAutores() {
        ...
        var autoresListar = autores.stream().map(AutorListarDTO::new).toList();
